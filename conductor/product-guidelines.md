...
## Производительность
- **Zero-copy передача данных:** Использование прямого доступа к памяти ImageSharp через P/Invoke для исключения аллокаций и копирования при передаче изображений в нативный код.
